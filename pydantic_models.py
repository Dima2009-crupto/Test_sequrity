...
class ContactModel(BaseModel):
    ...
    email: Annotated[EmailStr, Field(..., min_length=3, max_length=50, description="Email", exples=["email@i.ua"])]
    adres: Annotated[Optional[str], Field(None, max_length=150, description="Адреса", examples=["Україна, Київ, вул. Сікорського, буд. 56"])]
